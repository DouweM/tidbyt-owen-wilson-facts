...
1. Clone this repository and enter the new directory:
    ...
    ```bash
    git clone https://github.com/DouweM/tidbyt-owen-wilson-facts.git
    cd tidbyt-owen-wilson-facts
    ```
...
The image will be created at `output/owen-wilson-facts/<timestamp>.webp`.
